...
*Creating new object for clean data, and then summarizing mean temp.*
...
*Generated scatterplot for relationship between elevation and mean temp.*
...
*creating predictive model for mean temp. at elevation*
...
*^ This is a based off of the predictive model*
...
*Adding a result for model's predicted temp. at 900m*
...
*creating a model that also represents confidence interval in ribbon*
...
*Creating a table to summarize predictive model for temp. at elevation* 
